<#
This script can be used to export list of mailboxes with details from On premise Exchange.
...
# Change the file path to the Input csv file with SamAccountName of the users.
