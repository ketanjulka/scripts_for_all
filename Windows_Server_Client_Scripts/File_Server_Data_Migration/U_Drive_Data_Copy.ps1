...
for($i = 0; $i -lt $total.Count; $i++)
{
    ...
    robocopy "$src" "$des" /TBD /V /TEE /E /Z /DCOPY:DT /COPY:DAT /NP /ETA /MT:16 /R:5 /W:5 /XF ~$* /unilog:"S:\Scripts\Robocopy_Logs\copylog_$folderName.txt" /XD DfsrPrivate /XD "System Volume Information" /XD '$RECYCLE.BIN'
}